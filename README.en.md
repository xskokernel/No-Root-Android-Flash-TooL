...
| | Feature | Description |
|:---:|:---|:---|
| <img src="assets/icons/feat_noroot.png" width="40" /> | **No Root required** | No bootloader unlock, no Magisk, no system partitions touched — ready out of the box |
| <img src="assets/icons/feat_nopc.png" width="40" /> | **No PC required** | Phone-to-device directly, one OTG cable for the whole flow |
| <img src="assets/icons/feat_pipeline.png" width="40" /> | **Complete pipeline** | 9008 deep flash, Fastboot, MTK, and ADB — four channels |
| <img src="assets/icons/feat_root.png" width="40" /> | **Optional Root** | Root is an **option**, not a **barrier** — power users are welcome too |

---

## Features

### <img src="assets/icons/fn_9008.png" width="36" /> 9008 / EDL Deep Flash
...
### <img src="assets/icons/fn_fastboot.png" width="36" /> Fastboot Flashing
...
### <img src="assets/icons/fn_mtk.png" width="36" /> MTK TOOL (MediaTek Flashing)
...
### <img src="assets/icons/fn_adb.png" width="36" /> ADB Device Management
...
### <img src="assets/icons/fn_miui.png" width="36" /> Xiaomi / Redmi Platform Flashing
Detects Xiaomi fastboot package structure, flashes selected partitions, handles erasing in one go.

### <img src="assets/icons/fn_oplus.png" width="36" /> OPPO / OnePlus / realme Platform Flashing
Supports both Normal and Pure FastbootD modes, auto-scans images, and previews partitions.

### <img src="assets/icons/fn_payload.png" width="36" /> Payload Extraction
Reads the partition list from `payload.bin`, extracts on demand, with multi-threading and search.

### <img src="assets/icons/fn_sn.png" width="36" /> SN Patch
Patches Bootloader SN for a specified file.

### <img src="assets/icons/fn_ui.png" width="36" /> Refined Experience
